...
# 데이터셋 초기화 (예시 경로 및 파라미터 설정 필요)
root_dir = "C:/Users/Daehwan/Documents/8_project/07_OCR/level2-cv-datacentric-cv-11/03_train_val/data"  # 실제 데이터 경로로 변경
...
# 크롭된 이미지 (Normalize 반영하여 원래 색상 복원)
plt.subplot(1, 3, 1)
